 ...
 *
 * m$\ddot{x} + m\dot{x} = -V'(x) + a\cos(\omega t) + f + Gaussian, Poissonian and dichotomous noise
 *
 */
...
void usage(char **argv)
{
    ...
    printf("                                                        a: amp; w: omega, f: force; g: mass; D: Dg; p: Dp; l: lambda; i: fa; j: fb; m: mua; n: mub\n");
